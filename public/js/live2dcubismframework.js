...
(function(LIVE2DCUBISMFRAMEWORK) {
  ...
  var BuiltinAnimationSegmentEvaluators = (function() {
    ...
    BuiltinAnimationSegmentEvaluators.BEZIER = function(points, offset, time) {
      ...
      var p01 = BuiltinAnimationSegmentEvaluators.lerp(
        points[offset + 0],
        points[offset + 1],
        t
      );
      var p12 = BuiltinAnimationSegmentEvaluators.lerp(
        points[offset + 1],
        points[offset + 2],
        t
      );
      var p23 = BuiltinAnimationSegmentEvaluators.lerp(
        points[offset + 2],
        points[offset + 3],
        t
      );
  ...
  var Animator = (function() {
    ...
    Animator.prototype.updateAndEvaluate = function(deltaTime) {
      ...
      var paramStackFlags = new Array(this._target.parameters.count).fill(
        false
      );
  ...
  var PhysicsInput = (function() {
    ...
    PhysicsInput.prototype.evaluateFactor = function(
      ...
      var parameterMiddle = this.getMiddleValue(
        parameterMinimum,
        parameterMaximum
      );
  ...
  var PhysicsOutput = (function() {
    ...
    PhysicsOutput.prototype.evaluateValue = function(translation, particles) {
      ...
      if (this.factor.angle > 0) {
        ...
        var angleResult = Physics.directionToRadians(
          parentGravity,
          translation
        );
        value +=
  ...
  var PhysicsSubRig = (function() {
    ...
    PhysicsSubRig.prototype._update = function(deltaTime, target) {
      ...
      factor.y = xy.y;
      var factorRadians = a;
      var gravityDirection = Physics.radiansToDirection(
        factorRadians
      ).normalize();
    ...
    function PhysicsRig(target, timeScale, physics3Json) {
      ...
      physics3Json["PhysicsSettings"].forEach(function(r) {
        ...
        r["Vertices"].forEach(function(p) {
          var initialPosition = new PhysicsVector2(
            p["Position"]["X"],
            p["Position"]["Y"]
          );
          particles.push(
